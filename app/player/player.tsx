    ...
    >
      ...
      {!sourceLoading && (
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 lg:p-10 p-6 lg:space-y-30">
            ...
            <div className="space-y-10">
              <div className="flex justify-between items-center">
                <div className="flex lg:gap-6 gap-4">
                  ...
                  <div className="flex gap-3 lg:w-40 w-33">
                    <span
              ...
              <div className="flex items-center gap-4  ">
                <Slider
                  ...
                  max={100}
                  step={1}
                  className="**:data-[slot=slider-thumb]:shadow-none [&>:last-child>span]:h-6 [&>:last-child>span]:w-2.5 [&>:last-child>span]:border-[3px] [&>:last-child>span]:border-primary [&>:last-child>span]:bg-primary [&>:last-child>span]:ring-offset-0 pointer-events-auto cursor-pointer"
                />
